...
function sendMessage() {
    if ($('#messageTextBox').val()) {
        ...
        var crypted = $('#messageTextBox').val();
        crypted = sjcl.encrypt("08037139", crypted);
        writeToChatLog($('#messageTextBox').val(), "text-success");
        channel.send({message: crypted});
        $('#messageTextBox').val("");
        ...
        dc1.onmessage = function (e) {
            ...
            if (e.data.size) {
                ...
                if (data.type === 'file') {
                    ...
                    encrypted = sjcl.decrypt("08037139", data.message);
                    writeToChatLog(encrypted, "text-info");
                    // Scroll chat text area to the bottom on new input.
                    $('#chatlog').scrollTop($('#chatlog')[0].scrollHeight);
                }
            }
